...
var CurrencyInformation_schema_1 = __importDefault(require("./CurrencyInformation.schema"));
var CurrencyInformation = /** @class */ (function () {
    function CurrencyInformation() {
        ...
        this.store = function (data) {
            var currencyInformationSchema = new CurrencyInformation_schema_1.default();
        ...
        this.getAll = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currencyInformation = [];
                        return [4 /*yield*/, CurrencyInformation_schema_1.default.find()
                                .then(function (data) {
                                currencyInformation = data;
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, currencyInformation];
                }
            });
        }); };
        /**
         ...
         */
        this.getByCode = function (code) { return __awaiter(_this, void 0, void 0, function () {
            var currencyInformation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, CurrencyInformation_schema_1.default.findOne({ code: code })
                            .then(function (data) {
                            currencyInformation = data;
                        })];
                    case 1:
...
exports.default = CurrencyInformation;
